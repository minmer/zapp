...
import EditableTypeRadio from '../EditableTypeRadio';
...
describe('EditableRadio', () => {
    ...
    it('renders with the correct initial selection', () => {
        render(<EditableTypeRadio value="1" setValue={jest.fn()} options={options} />);
    ...
    it('calls setValue with the correct value on change', () => {
        ...
        render(<EditableTypeRadio value="1" setValue={setValueMock} options={options} />);
